...
uint256 hashGenesisBlock("0x4acdcab3e02319ca1cb9a93e7353070e4e75c73aba2afc29c1a2726157d27976");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Spcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Spcoin: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // Spcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca9899e3b31dfe9620ef91f5ea88b465836acb783b3fe989c4a43d5512232aaa");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Timesofindia 11/Jan/2018 Aadhaar adds fresh security layer with 16-digit ‘Virtual ID’";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040988437b8c4463a39bb79bb0988f4517a4d908e1f0e9dc8726fbcfc1e74ca146f2d17dc17d5e93d3a7f5f87ff858826c42a0c51f206624a93f3d9969442b02ab") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515662778;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085933837;

        if (fTestNet)
        {
            block.nTime    = 1515662789;
            block.nNonce   = 386484340;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x24db77dc2bd2dcd117bfbdcbbc9a0785d48b9916cba890b0766725819c7adafe"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc4, 0xb7, 0xd5 }; // Spcoin: increase each by adding 2 to bitcoin's value.
