    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Spcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  spcoind [options]                     " + "\n" +
                  "  spcoind [options] <command> [params]  " + _("Send command to -server or spcoind") + "\n" +
                  "  spcoind [options] help                " + _("List commands") + "\n" +
                  "  spcoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "spcoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: spcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: spcoind.pid)") + "\n" +
